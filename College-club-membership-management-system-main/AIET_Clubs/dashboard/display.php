...
<body class="p-3 mb-2 bg-white">
    ...
    <h2 class=" text-center text-primary animate__animated animate__backInDown animate__animated ">Members list</h2>
    <p><a href="add_member.php" class="btn btn-primary">Add Members</a></p>
