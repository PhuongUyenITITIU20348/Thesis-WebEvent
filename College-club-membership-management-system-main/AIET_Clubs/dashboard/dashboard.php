...
<body>
            ...
            <div class="self-center top-0 w-full max-w-7xl ">
                <div class="flex justify-between items-center text-gray-700">
                    ...
                    <ul class="hidden md:flex items-center text-[18px] font-semibold pr-10">
                     <li class="text-stone-600 hover:text-blue-600 hover:font-bold font-medium mx-4 my-1"><a href="../home/home.php">Home</a></li>
	...
	<div class="navbarheader bg-[#082f49] text-white animate__animated animate__flipInX">
        <div class="flex justify-center ">
            <div class="self-center top-0 w-full max-w-7xl ">
                <div class="flex justify-between items-center text-gray-700">
                    ...
                    <ul class="hidden md:flex items-center text-[18px] font-semibold pr-10">
                        ...
                        <button type="button" class="text-white hover:text-blue-600 hover:font-bold text-medium mx-4 my-1"><a href="dashboard1.php"> Members</a></button> <br><br><br>
                        <button type="button" class="text-white hover:text-blue-600 hover:font-bold text-medium mx-4 my-1"><a href="dashboard2.php"> Clubs</a></button>
                        <button type="button" class="text-white hover:text-blue-600 hover:font-bold text-medium mx-4 my-1"><a href="behavior.php"> Behavior Point</a></button>
                        <hr>
                        <br>
...
<video autoplay controls class="w-full h-auto object-cover rounded animate__animated animate__fadeInUp">
  <source src="../images/IU 20 năm vươn ra biển lớn.mp4" type="video/mp4" />
